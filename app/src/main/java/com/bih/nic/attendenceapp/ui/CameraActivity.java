...
import com.bih.nic.attendenceapp.utilities.CameraPreview;
import com.bih.nic.attendenceapp.utilities.GlobalVariables;
import com.bih.nic.attendenceapp.utilities.MarshmallowPermission;
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            try {
             ...
             /*   Bitmap bitmapAfterAddText = Utiilties.DrawText( bmapBitmap2, "Lat : " + Double.toString(GlobalVariables.glocation.getLatitude()), "Long :  " + Double.toString(GlobalVariables.glocation.getLongitude())
                ...
                Bitmap bitmapsp= BitmapFactory.decodeResource(CameraActivity.this.getResources(), R.drawable.circuler_shape);
